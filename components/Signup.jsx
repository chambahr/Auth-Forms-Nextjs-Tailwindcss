    ...
    <>
       ...
       <div className='bg-white shadoww-2xl rounded-2xl flex w-2/3 max-w-4xl'>
         ...
         {/* All content here is for the left section */}
          ...
          <CompanyName />
            <div className='py-10'>
              <h2 className='text-green-700 text-3xl font-bold mb-1'><span className='inline-block'><AiOutlineUserAdd /></span> Create Account</h2>
              ...
              <div className='flex flex-col items-center'>
                <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'>
                  ...
                  <input type="name" name='name' placeholder='Full Name'  className='bg-gray-100 text-sm flex-1 outline-none' />
                </div>
                <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'>
                ...
                <div className='flex justify-between w-64 mb-5'>
                  ...
                  <a href="#" className='text-xs m-1 hover:underline'></a>
                </div>

                <a href='#' className='border-2 border-green-700 px-12 py-2 rounded-full inline-block font-semibold hover:bg-green-700 hover:text-white'> Sign Up</a>
              </div>
          ...
          <div className='w-2/5 p-5 bg-green-700 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12'>
            <h2 className='text-3xl mb-8 font-bold'>Hello, Already Got An Account?</h2>
